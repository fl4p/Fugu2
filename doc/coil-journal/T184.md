...
![img_4.png](img/img_4.webp)

- Power measurement:
    - V=73/28.5, I=29.7A, Ipp=18A
    - Ploss = -4.4784 std= 0.1549
      ![img_3.png](img/img_3.webp)
...
- Power measurement
    - I=30.7A Ipp=16.7 (!) => L=26.7µH (33% of L0)
    - Ploss= -3.7764 std= 0.2066

notes:
- could add more strands for higher ID usage

# KS184-125A, 1.8mm? (Cu?), 2 strands, 24turns
![img.png](img.png)
...
- Power measurement:
    - V=73/28.5, I=29.7A, Ipp=13A => Ldc= 34.3µH
    - Ploss = 10.6W +- 0.2W
...
![img_9.png](img/img_9.webp) ![img_10.png](img/img_10.webp)
...
# 2s Maginc equiv of MS184-075 (184075)
* has a 75 marking
* 14 turns?
* L0 = 69uH
* 3.02mΩ dcr
